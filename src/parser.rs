        ...
        match thing {
                ...
                && prev == '\'' =>
            {
                if let Some(prev) = args.last()
                    && prev.state == ParserState::SingleQuote
                {
            ...
            thing if thing.is_whitespace() => match current_arg.state {
            ...
            _ => {
                    ...
                    && prev == '\''
                {
                        ...
                        && prev.state == ParserState::SingleQuote
                    {
                        let prev_arg = args.pop().unwrap();
                        current_arg.value = prev_arg.value;
                        current_arg.state = ParserState::NoQuote;
                    }
                }
...
impl Parser {
    ...
    // TODO: This function is broken. RIP
